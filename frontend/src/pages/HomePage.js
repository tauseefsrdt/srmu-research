          ...
          <div style={styles.peopleGrid}>
            ...
            <div style={styles.person}>
              <img
                ...
                style={styles.personImage}
              />
              <h5 style={styles.personName}>Prof. (Dr.)Nabeel Ahmad</h5>
              <p style={styles.personRole}> Director (Research)</p>
            </div>
            <div style={{ ...styles.person, gridColumn: isMobile ? "1 / -1" : "auto", justifySelf: isMobile ? "center" : "auto" }}>
              <img
              ...
              <p style={styles.personRole}>Deputy Director (Research)</p>
            </div>
          </div>
        </div>
      </div>
